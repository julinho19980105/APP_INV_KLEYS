...
export default function MovementsPage() {
  ...
  const movementsRef = React.useMemo(() => 
    db ? query(collection(db, "movements"), orderBy("timestamp", "desc"), limit(100)) : null
  , [db])
    ...
    <div className="space-y-6 pt-2 pb-24 px-2 md:px-0 max-w-4xl mx-auto">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-primary/10 pb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-headline font-black text-foreground uppercase tracking-tight">Movimientos</h1>
            <p className="text-[9px] font-black text-primary uppercase tracking-[0.2em] mt-0.5">Historial Reciente</p>
          </div>
        </div>
        ...
        <div className="flex w-full md:w-auto gap-2">
          ...
          <Select value={typeFilter} onValueChange={setTypeFilter}>
            ...
            <SelectContent className="rounded-xl">
              ...
              <SelectItem value="in" className="text-[9px] font-black uppercase">Entrada</SelectItem>
              <SelectItem value="out" className="text-[9px] font-black uppercase">Salida</SelectItem>
              <SelectItem value="return" className="text-[9px] font-black uppercase">Retorno</SelectItem>
            </SelectContent>
          </Select>
        </div>
      </div>
      ...
      <div className="space-y-3">
        {loading ? (
          <div className="flex flex-col items-center justify-center py-20 gap-4 opacity-30">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest">Cargando Kardex...</span>
          </div>
              ...
              <CardContent className="p-4 flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <div className="text-[8px] font-black text-primary/30 uppercase tracking-widest mt-1">
                    {date.toLocaleDateString('es-ES', { day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                  </div>
                </div>
              </CardContent>
            </Card>
